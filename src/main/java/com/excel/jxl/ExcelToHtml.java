...
import org.openxmlformats.schemas.drawingml.x2006.spreadsheetDrawing.impl.CTPictureImpl;
...
public class ExcelToHtml {
    ...
    public static void excelToHtml(String path, String htmlPath) {
        ...
        try {
            ...
            writeFile(htmlExcel, htmlPath, fileName);
        } catch (Exception e) {
            e.printStackTrace();
        } finally {
            try {
            ...
            if (dr instanceof XSSFDrawing) {
                ...
                for (XSSFShape shape : shapes) {
                    if (shape instanceof XSSFPicture) {
                        ...
                        XSSFPicture pic =  patriarch.createPicture((ClientAnchor) anchor,
                                simpleShape.getShapeId());
